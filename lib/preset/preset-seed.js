...
- id: persona
  ...
  config:
    text: |-
      ...
      - Strictly one page. Saved as PDF, named Firstname_Lastname_Cover_Letter_Job_Company.pdf — the same convention the CV exports under (Firstname_Lastname_CV_Job_Company.pdf), so a candidacy's two files sort together.
