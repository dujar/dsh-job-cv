...
function skillInstructions() {
  ...
  return [
    ...
    '     and the form fills in its path). Both usually arrive in the first',
    '     message. Read the CV with your file tools (a PDF or DOCX needs',
    '     converting first: pdftotext, or unzip the .docx and read',
    '     word/document.xml).',
    ...
    '     document (html, jobUrl, version, workspace) or an empty shell.',
