...
/** Fit bands mirror the fit panel's own thresholds (strong ≥75, partial ≥50). */
var FIT_BAND_OPTIONS = [
  { key: 'any', label: 'any fit' },
  { key: 'scored', label: 'scored' },
  { key: 'unscored', label: 'not scored yet' },
  { key: 'strong', label: 'strong · 75%+' },
  { key: 'partial', label: 'partial · 50–74%' },
  { key: 'thin', label: 'thin · under 50%' },
]
...
/** Which fit band does this row land in? Mirrors the fit panel's thresholds. */
