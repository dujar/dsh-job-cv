              ...
              : createElement('iframe', {
                  ...
                  onLoad: function () {
                    ...
                    try {
                      ...
                      var body = frame && frame.contentDocument && frame.contentDocument.body
                      if (frame && body)
                        frame.style.height = Math.max(body.scrollHeight, 1123) + 'px'
                    } catch (e) {
                      /* keep minHeight */
                    }
                    bumpLoad(function (n) {
                  ...
                  style: {
                    // TRUE A4, always: the document must lay out at the same
                    // 210mm the PDF prints at. maxWidth:100% shrank the frame
                    // to the pane, reflowing the text narrower and taller —
                    // the preview and the print were measuring different
                    // layouts. A pane narrower than the sheet scrolls.
                    width: '210mm',
                    maxWidth: 'none',
                    margin: '0 auto',
                    height: 'fit-content',
