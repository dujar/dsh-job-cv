...
// upserts the candidacy workspace and tailors the CV.
...
/** The chat message the start form hands to the agent. */
function buildStartMessage(link, cvPath) {
  return [
...
function StartForm(props) {
  ...
  function submit() {
    ...
    var via = sendToComposer(inputActions, buildStartMessage(jobLink, cvPath))
    setStatus(
      via === null
